           ...
           <div class="modal-body">
				<form>
                    <div class="form-group">
                        ...
                        <input wire:model="id_municipio" type="text" class="form-control" id="id_municipio" placeholder="Id Municipio">@error('id_municipio') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
